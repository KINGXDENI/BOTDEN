...
exports.textmenupenting = (pushname) => {
    return `
Hi Kak ${pushname}👋️, selamatt datang di Denbot WhatsApp pintar yang siap membantumu.
...
List menu penting Denbot:

Silahkan Yang ingin mendapatkan info Denbot lebih cepat ketik 
${prefix}grup
tapi gk usah keluar masuk grup ya :)

🚀 *${prefix}addbacot*
Untuk melihat bacotan member Denbot
...
🚀 *${prefix}listbacot*
Untuk melihat list bacotan member Denbot
...
12. *${prefix}hilih*
Untuk Den bot merubah kata hilih
Usage: Ketik */hilih* teksnya

15. *${prefix}getpic*
Untuk Den bot maling gambar orang
...
Selamat menikmati✨
_made with_❤️ @Denbot`

}

exports.textsongmenu = (pushname) => {
   return `
Hi Kak ${pushname}👋️, selamat datang di Denbot WhatsApp pintar yang siap membantumu.
Follow Ig Admin Untuk Menunjukan Support Terhadap Bot ini
${sosmed}
Berikut fitur yang dapat di gunakan pada bot ini✨
...
*Ketik /chat* 
*Untuk Mengobrol dengan Denbot*
*Jika ingin membuat sticker atau menu lainnya silahkan di offkan Denbot chatnya*

List menu:

1. *${prefix}menupenting*
Menampilkan menu penting di Denbot
Usage: ketik */menupenting*

2. *${prefix}menuhiburan*
Menampilkan menu hiburan di Denbot
Usage: ketik */menuhiburan*

3. *${prefix}mentol*
Menampilkan menu tools & alat di Denbot
Usage: ketik */mentol*
...
exports.textmenubaru = (pushname,role,point,level, premii , _registered , colooo , todd) => {
    return `
┏━━❉ *PROFIL* ❉━━┓
┃  *NAMA  \t: ${pushname}*
┃  *LEVEL \t: ${premii}*
...
┣⊱ *[6]${prefix}premmenu*
┣⊱ *[7]${prefix}tobatmenu*
┣⊱ *[8]${prefix}stickermenu*
┣⊱ *[9]${prefix}nulismenu*
┣⊱ *[10]${prefix}downloadmenu*
┣⊱ *[11]${prefix}imagemenu*
┣⊱ *[12]${prefix}logomenu*
┣⊱ *[13]${prefix}gamemenu*
┣⊱ *[14]${prefix}groupmenu*
...
Denbot terdapat 2 menu sekarang

🐳 *${prefix}menubaru* 🐳
🐳 *${prefix}𝚖𝚎𝚗𝚞lama* 🐳

Jam: *${tod}*
Total userDen : ${coloo.length}

Jika tulisan tidak keliatan kek kotak kotak 
Ketik /help

Untuk melihat Waktu Denbot Aktif
...
List menu wibuarea & kpop di Denbot:
...
4. *${prefix}ttp*
Untuk Den bot mengirim sticker text
...
exports.textAdmin = () => {
    return `
⚠ [ *Admin Group Only* ] ⚠ 
Berikut adalah fitur admin grup yang ada pada ❣ *DenBot* ❣!
...
⚠ [ *Owner Group Only* ] ⚠
Berikut adalah fitur owner grup yang ada pada ❣ *DenBot* ❣!
🐼 *${prefix}kickall*
